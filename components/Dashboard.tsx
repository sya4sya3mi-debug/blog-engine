...
          <button onClick={() => d.setActiveTab("generate")} style={{ background: "linear-gradient(135deg,#00D4FF,#00C896)", border: "none", borderRadius: 10, padding: "10px 20px", color: "#000", fontWeight: 800, fontSize: 13, cursor: "pointer", flexShrink: 0 }}>✦ 記事を生成する</button>
        </header>
